...
static const char* ImGui_ImplSdl_GetClipboardText(void* bogus)
{
    (void) bogus;
    return SDL_GetClipboardText();
}

static void ImGui_ImplSdl_SetClipboardText(void* bogus, const char* text)
{
    (void) bogus;
...
#if defined(_WIN32) && !defined(SDL_VIDEO_DRIVER_WINRT)
